...
int main(int argc, char *argv[], char *env[]) {
    ...
    if((pid2 = fork()) == 0) {
        ...
        /* 
         * This waits for ANY child to die.  
         * It doesn't matter if the child dies normally or from a signal.  
         * The status information is then stored in the status integer.
         *
        ...
        /*
         * The information in status is *NOT* the return code!!  
         * To make use of the information we must macros to extract the needed information.
         * WIFEXITED() determines if the process exited normally (returned a number).
         * This can be done through a return or exit()
         */
